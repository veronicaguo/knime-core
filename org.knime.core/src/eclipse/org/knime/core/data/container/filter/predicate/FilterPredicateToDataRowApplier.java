...
public final class FilterPredicateToDataRowApplier implements Visitor<Boolean> {
    ...
    public <T> Boolean visit(final MissingValuePredicate<T> mvp) {
        final Function<T, Boolean> function = t -> t == null;
        return mvp.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }

    @Override
    public <T> Boolean visit(final CustomPredicate<T> udf) {
        final Function<T, Boolean> function = t -> t != null && udf.getPredicate().test(t);
        return udf.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }

    @Override
    public <T> Boolean visit(final EqualTo<T> eq) {
        final Function<T, Boolean> function = t -> t != null && t.equals(eq.getValue());
        return eq.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }

    @Override
    public <T> Boolean visit(final NotEqualTo<T> neq) {
        final Function<T, Boolean> function = t -> t != null && !t.equals(neq.getValue());
        return neq.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }
    ...
    public <T extends Comparable<T>> Boolean visit(final LesserThan<T> lt) {
        ...
        return lt.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }
    ...
    public <T extends Comparable<T>> Boolean visit(final LesserThanOrEqualTo<T> leq) {
        ...
        return leq.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }
    ...
    public <T extends Comparable<T>> Boolean visit(final GreaterThan<T> gt) {
        ...
        return gt.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }
    ...
    public <T extends Comparable<T>> Boolean visit(final GreaterThanOrEqualTo<T> geq) {
        ...
        return geq.getColumn().accept(new ColumnToDataCellApplier(m_dataRow, function));
    }
    ...
    static final class ColumnToDataCellApplier
        ...
        ColumnToDataCellApplier (final DataRow dataRow, final Function<?, Boolean> function) {
            m_dataRow = dataRow;
            m_function = function;
        }
